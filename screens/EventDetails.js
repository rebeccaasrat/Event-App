...
const handleAttendEvent = async () => {
  console.log('Attending the event:', event?.id,user);

 const userQuery = query(collection(db, 'User'), where('email', '==', user));
    ...
    const userCollection = doc(db, 'User', userId);
  ...
  try {
    ...
    alert(`You have joined ${event.title} successfully`);
